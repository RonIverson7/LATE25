...
import RequestsTab from "./subPages/manage/RequestsTab";
import StatisticsTab from "./subPages/manage/StatisticsTab";
import UsersTab from "./subPages/manage/UsersTab";
import "../styles/main.css";

export default function ManagePage() {
  const [activeTab, setActiveTab] = useState('requests'); // 'requests', 'statistics', 'users'
